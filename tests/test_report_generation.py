...
def test_generate_report_html_and_excel(tmp_path, mock_source_df, mock_target_df):
    ...
    # Pass output_dir directly instead of monkey-patching module-level constant
    output_dir_str = str(tmp_path)

    # Test HTML report generation
    res_html = generate_report.func("html", output_dir=output_dir_str)
    ...
    res_xlsx = generate_report.func("excel", output_dir=output_dir_str)
